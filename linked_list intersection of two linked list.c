...
void intersectionlinkedlist(struct node *START1,struct node *START2)
{
  struct node *p,*q;
...
orderedinsertion( &START2, 45);
 Traverse(START1);  
  ...
  Traverse(START2);
   printf("\n");
  intersectionlinkedlist(START1,START2);
